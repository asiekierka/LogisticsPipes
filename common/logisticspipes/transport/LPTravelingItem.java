...
public abstract class LPTravelingItem {
	...
	public static final class LPTravelingItemServer extends LPTravelingItem implements IRoutedItem {
		...
		public void readFromNBT(NBTTagCompound data) {
			...
			input = DirectionUtils.getFacingNullable(data.getInteger("input"));
			output = DirectionUtils.getFacingNullable(data.getInteger("output"));
		...
		public EntityItem toEntityItem() {
			...
			if (MainProxy.isServer(worldObj)) {
				...
				DoubleCoordinates position = new DoubleCoordinates(container.getPos().add(0.5, 0.375, 0.5));
