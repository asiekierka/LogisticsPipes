...
public class LPWorldEventListener implements IWorldEventListener {

	private final World world;
	private final LPWorldInfo info;

	public LPWorldEventListener(World world, LPWorldInfo info) {
		this.world = world;
		this.info = info;
	}
	...
	public void notifyBlockUpdate(World worldIn, BlockPos pos, IBlockState oldState, IBlockState newState, int flags) {
		// TODO: markBlockForUpdate is this?
