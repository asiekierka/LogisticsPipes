...
public class ServerRouter implements IRouter, Comparable<ServerRouter> {
	...
	public void CreateRouteTable(int version_to_update_to, IRoutingDebugAdapter debug) {
		...
		routeCosts.add(new ExitRoute(this, this, EnumFacing.UNKNOWN, EnumFacing.UNKNOWN, 0, EnumSet.allOf(PipeRoutingConnectionType.class), 0));
		...
		routeTable.set(simpleID, new OneList<>(new ExitRoute(this, this, EnumFacing.UNKNOWN, EnumFacing.UNKNOWN, 0, EnumSet
	...
	public boolean isSideDisconneceted(EnumFacing dir) {
		return EnumFacing.UNKNOWN != dir && sideDisconnected[dir.ordinal()];
	}
