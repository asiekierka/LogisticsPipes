	...
	public void throttledUpdateEntity() {
		...
		//@formatter:on
				.forEach(fluidHandlerDirectionPair -> {
					FluidTankInfo[] tankInfo = fluidHandlerDirectionPair.getValue1().getTankInfo(EnumFacing.UNKNOWN);
					...
					FluidTankInfo[] result = container.getTankInfo(EnumFacing.UNKNOWN);
